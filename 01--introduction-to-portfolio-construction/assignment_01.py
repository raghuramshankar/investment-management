...
returns_m = df.get(["Lo 20", "Hi 20"])
returns_slice_m = df["1999":"2015"].get(["Lo 20", "Hi 20"])

returns_y, volatility_y = rk.annualized_returns(returns_m, 12)
returns_slice_y, volatility_slice_y = rk.annualized_returns(returns_slice_m, 12)
...
"""plot and print"""
print("1: Lo 20 Yearly returns =", round(returns_y["Lo 20"]*100, 2), "%")
print("2: Lo 20 Yearly volatility =", round(volatility_y["Lo 20"]*100, 2), "%")
print("3: Hi 20 Yearly returns =", round(returns_y["Hi 20"]*100, 2), "%")
print("4: Hi 20 Yearly volatility =", round(volatility_y["Hi 20"]*100 ,2), "%")
print("5: Lo 20 Yearly returns 1999-2015 =", round(returns_slice_y["Lo 20"]*100, 2), "%")
print("6: Lo 20 Yearly volatility 1999-2015 =", round(volatility_slice_y["Lo 20"]*100, 2), "%")
print("7: Hi 20 Yearly returns 1999-2015 =", round(returns_slice_y["Hi 20"]*100, 2), "%")
print("8: Hi 20 Yearly volatility 1999-2015 =", round(volatility_slice_y["Hi 20"]*100, 2), "%")
print("9: Lo 20 Max drawdown value 1999-2015 =", - round(drawdown_slice_min["Lo 20"]*100, 2), "%")
print("10: Lo 20 Max drawdown date 1999-2015 =", (drawdown_slice_idxmin["Lo 20"]).strftime("%Y-%m"))
print("11: Hi 20 Max drawdown value 1999-2015 =", - round(drawdown_slice_min["Hi 20"]*100, 2), "%")
